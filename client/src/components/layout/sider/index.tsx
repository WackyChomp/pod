  ...
  return (
    <>
      ...
      >
        ...
        <Drawer
          variant="permanent"
          PaperProps={{ elevation: 0 }}       // 0 removes shadow , originally at 1
          sx={{
        ...
        >
          ...
          <Button
            sx={{
              background: "yellow",     // rgba(0,0,0,.5)
              color: "primary.contrastText",
              textAlign: "center",
              borderRadius: 0,
              borderTop: "1px solid #ffffff1a", '&:hover':{ background: 'green'}
            }}
            fullWidth
            size="large"
